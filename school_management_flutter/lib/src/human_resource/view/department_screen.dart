...
import 'package:school_management_flutter/src/human_resource/vm/department.vm.dart';
import 'package:school_management_flutter/styles.dart';
import 'package:statemanagement_riverpod_mvvm/riverpod_mvvm.dart';

class DepartmentScreen extends StatelessView<DepartmentVM> {
  const DepartmentScreen({super.key});

  @override
  ViewModelProvider<DepartmentVM> get vm => departmentVmProvider;

  @override
  Widget render(BuildContext context, DepartmentVM vm, ref) {
    return Scaffold(
      body: Padding(
...
class CreateDepartmentView extends StatelessWidget {
  final DepartmentVM vm;
  const CreateDepartmentView({super.key, required this.vm});
...
class DepartmentListView extends StatelessWidget {
  final DepartmentVM vm;
  const DepartmentListView({super.key, required this.vm});
