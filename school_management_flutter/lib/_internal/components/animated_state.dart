...
class AnimatedTextSpike extends StatefulWidget {
  const AnimatedTextSpike({super.key});

  @override
  AnimatedTextSpikeState createState() => AnimatedTextSpikeState();
}

class AnimatedTextSpikeState extends AnimatedState<AnimatedTextSpike> {
  @override
